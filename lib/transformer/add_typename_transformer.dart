    ...
    return OperationDefinitionNode(
      ...
      selectionSet: SelectionSetNode(
        selections: <SelectionNode>[
          ...node.selectionSet.selections.where((element) => (element is! FieldNode || element.name.value != typeName)),
      ...
      selectionSet: SelectionSetNode(
        selections: <SelectionNode>[
          ...node.selectionSet?.selections
                  .where((element) => element is! FieldNode || element.name.value != typeName) ??
              [],
          FieldNode(name: NameNode(value: typeName)),
        ],
      ),
